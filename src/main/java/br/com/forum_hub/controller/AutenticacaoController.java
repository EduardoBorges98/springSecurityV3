...
public class AutenticacaoController {
    ...
    public ResponseEntity<DadosToken> efetuarLogin(@Valid @RequestBody DadosLogin dados) {
        ...
        String tokenAcesso = tokenService.gerarToken((Usuario) autentication.getPrincipal());
        String refreshToken = tokenService.gerarRefreshToken((Usuario) autentication.getPrincipal());
